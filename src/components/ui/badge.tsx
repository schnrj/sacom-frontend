  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-smooth focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        gradient:
          "border-transparent bg-gradient-primary text-primary-foreground hover:opacity-90",
        "gradient-accent":
          "border-transparent bg-gradient-accent text-accent-foreground hover:opacity-90",
      },
    },
    defaultVariants: {
      variant: "default",
